...
//    获得值    -g
    fprintf(stderr, "semtool -g 获得值\n");
//    设置值    -s <val>
    fprintf(stderr, "semtool -s <val> 设置值\n");
//    p操作	 -p
    fprintf(stderr, "semtool -p p操作\n");
//    v操作     -v
    fprintf(stderr, "semtool -v v操作\n");
//    查看权限   -f
    fprintf(stderr, "semtool -f 查看权限\n");
//    更改权限   -m <mode>
    fprintf(stderr, "semtool -m <mode> 更改权限\n");
}
